...
credset.genes <- c("SLC2A14", "SLC2A3")
...
# Prep locus plot
pdf(paste(out.prefix, "locus_highlight.SLC2A3.pdf", sep="."), height=3*2, width=3.25*2)
...
add.genes(genes[which(genes$gene %in% credset.genes), ], n.rows=1, 
          ...
          y.axis.title="", y.axis.title.col="black", label.genes=credset.genes)
