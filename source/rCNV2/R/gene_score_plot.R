...
#' @param hc.lab label for high confidence genes \[default: "High Conf."\]
#' @param lc.lab label for low confidence genes \[default: "Low Conf."\]
...
#' @export
plot.feature.bydsgroup <- function(feats, ds.groups, hc.lab="High Conf.",
                                   lc.lab="Low Conf.", feat.idx=2, title=NULL,
  ...
  vals <- list("hi.hc"=vals$hi.hc, "ds.hc"=vals$ds.hc, "ts.hc"=vals$ts.hc,
               ...
               "ns"=vals$ns)
  ylims <- range(unlist(vals[-length(vals)]), na.rm=T)
  ...
  axis(1, at=1.5, line=0.1, labels=hc.lab, tick=F)
  axis(1, at=5.5, line=0.1, labels=lc.lab, tick=F)
