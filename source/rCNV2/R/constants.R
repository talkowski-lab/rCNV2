...
load.rcnv.env <- function(load.strings=TRUE, load.colors=TRUE, load.scales=TRUE){
  ...
  if(load.strings == TRUE){
    ...
    constants <- list(
      ...
      adult.hpos = c("HP:0002011", "HP:0011121", "HP:0001626", "HP:0011442",
                     ...
                     "HP:0012447"),
      ml.model.abbrevs = c("ensemble" = "Ensemble Classifier",
                           "lda" = "LDA",
      ...
      score.abbrevs = c("pHaplo" = "pHaplo",
                        ...
                        "rvis_pct" = "RVIS Pct.",
                        "exac_del_z" = "ExAC DEL Z",
                        "exac_dup_z" = "ExAC DUP Z",
                        "exac_cnv_z" = "ExAC CNV Z",
                        "hurles_hi" = "HI Index",
                        "eds" = "EDS",
                        "sHet" = "sHet",
                        ...
                        "episcore" = "EpiScore"),
      score.names = c("pHaplo" = "pHaplo (This study)",
                        "pTriplo" = "pTriplo (This study)",
                        "gnomad_pLI" = "pLI (Karczewski 2020)",
                        "gnomad_pRec" = "pRec (Karczewski 2020)",
                        "gnomad_pNull" = "pNull (Karczewski 2020)",
                        "gnomad_oe_lof_upper" = "LOEUF (Karczewski 2020)",
                        "gnomad_oe_mis_upper" = "Mis. OEUF (Karczewski 2020)",
                        "rvis_pct" = "RVIS Pct. (Petrovski 2013)",
                        "exac_del_z" = "DEL Z-SCore (Ruderfer 2016)",
                        "exac_dup_z" = "DUP Z-Score (Ruderfer 2016)",
                        "exac_cnv_z" = "CNV Z-Score (Ruderfer 2016)",
                        "hurles_hi" = "HI Index (Huang 2010)",
                        "eds" = "EDS (Wang 2020)",
                        "sHet" = "sHet (Cassa 2017)",
                        "ccdg_del" = "CCDG DEL Score (Abel 2020)",
                        "ccdg_dup" = "CCDG DUP Score (Abel 2020)",
                        "episcore" = "EpiScore (Teschendorff 2020)")
    )
  ...
  if(load.colors == TRUE){
    ...
    constants <- list(
      ...
      pheno.colors = c("all" = blueblack,
                       "neuro" = "#ED6EBA",
                       "somatic" = "#48912B"),
      severity.colors = c("all" = blueblack,
                          "developmental" = "#FA8714",
                          "adult" = "#59493E"),
